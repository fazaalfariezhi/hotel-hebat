...
{{-- ----------------------------------------------------------------------DELETE---------------------------------------------------------------------------------- --}}
        ...
        @endif
        <div class="card-body">
          <h5 class="card-title">Data Semua Fasilitas Hotel</h5>
          <a href="/fasilitas-hotel/create" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Tambah Fasilitas</a>

          <div class="row">
            <div class="col-xl">
              <div class="card">
                  <img src="../../assets/images/card_1.jpg" class="card-img-top" alt="Placeholder">
                  <div class="card-body">
                      <h5 class="card-title">Basic Example</h5>
                      <p class="card-text">This is an example of a basic card. Cards have no fixed width to start, so they’ll naturally fill the full width of its parent element. This is easily customized with our various sizing options.</p>
              ...
              <div class="card bg-dark text-white">
                  <img src="../../assets/images/card_2.jpeg" class="card-img" alt="...">
          ...
          {{-- <table id="zero-conf" class="display" style="width:100%">
            <thead>
              <tr>
                ...
                <th scope="col">Gambar Fasilitas</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $fh->nama }}</td>
                <td>{{ $fh->keterangan }}</td>
                <td><a href="{{ asset('storage/' . $fh->image) }}"><img src="{{ asset('storage/' . $fh->image) }}" alt="" class="img-fluid img-thumbnail" style="max-width: 150px"></a></td>
                <td>
                  <a href="/fasilitas-hotel/{{ $fh->slug }}/edit" class="btn btn-success"><i class="bi bi-pencil-fill"></i>Edit</a>
                  <a href="#" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#{{ $fh->slug }}"><i class="bi bi-trash-fill"></i>Delete</a>
                </td>
              </tr>
              <div class="modal fade" id="{{ $fh->slug }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="/fasilitas-hotel/{{ $fh->slug }}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="/fasilitas-hotel" method="POST" enctype="multipart/form-data" class="mb-4">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" cols="75" rows="5" class="d-block form-control @error('keterangan') is-invalid @enderror mb-3" spellcheck="false" value="{{ old('keterangan') }}"></textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
